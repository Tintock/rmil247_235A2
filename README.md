# rmil247_235A2
Assignment for 235 using python flask, html and hopefully no javascript
...
The *a2movie/.env* file contains variable settings. They are set with appropriate values.
...
Appilcation was written in VS-CODE and run from a VS-Code venv virtual envioment
